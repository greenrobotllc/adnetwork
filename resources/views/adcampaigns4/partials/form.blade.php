...
<script>
  $(function() {
    ...
    if($('form input[id=start_specific]:checked').val()== "specific") {


     <?php if(isset($campaign->start_date)) {
      ?>
      $("#datepicker").val("<?php echo(Date('m/d/Y', strtotime($campaign->start_date))); ?>");
      <?php } ?>
    ...
    if($('form input[id=end_specific]:checked').val()== "specific") {


     <?php if(isset($campaign->end_date)) {
      ?>
      $("#datepicker2").val("<?php echo(Date('m/d/Y', strtotime($campaign->end_date))); ?>");
      <?php } ?>
    ...
    if($('form input[id=country_all]:checked').val()== "all") {


     <?php if(isset($campaign->all_countries)) {
      ?>
    ...
    else if($('form input[id=country_include]:checked').val()!= "include") {
      ...
      $('.ui.fluid.dropdown').dropdown('set selected',[<?php
       foreach(explode(",", $campaign->countries) as $country) {
        echo "\"$country\", ";
      }
      ?>
      ]);
    ...
    <?php if(isset($campaign->all_devices) && $campaign->all_devices == 2) {
      //echo "WTF";
      echo("$( \"#specific_devices\" ).hide();");
    ...
    if($('form input[id=all_devices_radio]:checked').val()== "all_devices") {


     <?php if(isset($campaign->all_devices) && $campaign->all_devices == 1) {
      ?>
      $( "#specific_devices" ).hide();
      $( "#all_or_specific_os" ).hide();
      <?php } ?>
    ...
    if($('form input[id=all_os]:checked').val()== "all_os") {


     <?php if(isset($campaign->all_operating_systems)) {
      ?>
      $( "#specific_os" ).hide();
      <?php } ?>
    ...
    if($('form input[id=mobile]:checked').val()== "mobile" || $('form input[id=tablet]:checked').val()== "tablet") {
      $( "#all_or_specific_os" ).show();
...
//$theEndDate = Date('m/d/Y', strtotime($campaign->end_date)); 




  //if($('form input[name=datepicker2]').val() !="") {
 ...
 // }
   ...
   //$( "#specific_os" ).hide();
   //$( "#all_or_specific_os" ).hide();
   //$( "#all_or_specific_device" ).hide();





   $('input[name="optradioos"]').change(function(){
    if($('#all_os').prop('checked')){
   ...
   $('input[name="optradio"]').change(function(){
    if($('#start_immediately').prop('checked')){
            //alert('Option 1 is checked!');
            $( "#datepicker" ).hide();
   ...
   $('input[name="optradio2"]').change(function(){
    if($('#end_immediately').prop('checked')){
            //alert('Option 1 is checked!');
            $( "#datepicker2" ).hide();
   ...
   $('input[name="optradiocountry"]').change(function(){
   ...
   $('input[name="optradiodevices"]').change(function(){
    if($('#all_devices_radio').prop('checked')){
            //alert('Option 1 is checked!');
            $( "#specific_devices" ).hide();
            $( "#specific_os" ).hide();
            $( "#all_or_specific_device" ).hide();
   ...
   jQuery("#specific_devices").contents().find("#mobile,#tablet").bind('change', function(){        
        val = this.checked; //<---
       // alert("changed");
        //alert(this.id);
        if(val) {
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="text" name="name" class="form-control" id="name" placeholder="Name" minlength="1" maxlenght="50" value="{{ $campaign->name }}" required>
  </div>
</div>
<br>&nbsp;<br>

<div class="form-group">
  <label for="name" class="col-sm-2 control-label" required>Bid Amount</label>
  <div class="col-sm-10">
    <table><tr><td>$</td><td>
      <input type="text" name="bid_amount" class="form-control" id="bid_amount" placeholder="Bid Amount" value="{{ $campaign->bid_amount  }}" minlength="3" maxlengh="10" required></td><td>

      &nbsp;Per Click</div></td></tr></table>
    </div>
  ...
  <div class="form-group">
    <label for="name" class="col-sm-2 control-label" required>Daily Budget Amount</label>
    <div class="col-sm-10">
      <input type="text" name="budget_amount" class="form-control" id="bid_amount" placeholder="Budget Amount" minlength="1" maxlength="10" value="{{ $campaign->budget_amount }}" required>
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="name" class="col-sm-2 control-label" required>Start Date</label>
...
//print_r($campaign);
      ...
      <div class="radio">
        <label><input 
          <?php if($campaign->start_date < date('Y-m-d H:i:s')) {
            echo("checked='checked'");
          }
          ?>
          type="radio" id="start_immediately" name="optradio" value="immediately">Immediately</label>
        </div>
        <div class="radio">
          <label><input type="radio" <?php if($campaign->start_date > date('Y-m-d H:i:s')) {
            echo("checked='checked'");
          }
          ?>
          id="start_specific" name="optradio" value="specific">Specific Date</label>
        </div>
      ...
      <?php
//print_r($campaign->end_date);
      ?>

      <div class="form-group">
        <label for="name" class="col-sm-2 control-label" required>End Date</label>
...
//print_r($campaign);
          ...
          <div class="radio">
            <label><input <?php if($campaign->end_date == null) {
              echo("checked='checked'");
            }
            ?>
            type="radio" id="end_immediately" name="optradio2" value="never">Never Ends</label>
          </div>
          <div class="radio">
            <label><input <?php if($campaign->end_date != null) {
              echo("checked='checked'");
            }
            ?> type="radio" id="end_specific" name="optradio2" value="specific">Specific Date</label>
          </div>


          <p><input type="text" name="datepicker2" id="datepicker2"></p>
      ...
      <div class="form-group">
        <label for="name" class="col-sm-2 control-label" required>Country Targeting</label>
        ...
        <div class="col-sm-10">
          ...
          <div class="radio">
            <label><input <?php if($campaign->all_countries == 1) {
              echo("checked='checked'");
            }
            ?>

            type="radio" id="country_all" name="optradiocountry" value="all">All Countries</label>
          </div>
          <div class="radio">
            <?php
//print_r($campaign);
            ?>
            <label><input <?php if( $campaign->all_countries == 0) {
              echo("checked='checked'");
            } 
            ?>
            type="radio" id="country_include" name="optradiocountry" value="include">Include</label>
          </div>
          ...
          <div id="country_dropdown">
            ...
            <div class="ui multiple fluid search selection dropdown" id="hybrid">
      ...
      <div class="form-group" required>
        <label for="name" class="col-sm-2 control-label" required>Device Targeting</label>
        ...
        <div class="col-sm-10">
          ...
          <div class="radio">
            <label><input <?php if($campaign->all_devices == 1) {
              echo("checked='checked'");
            }
            ?>
            type="radio" id="all_devices_radio" name="optradiodevices" value="all_devices">All Devices</label>
          </div>
          <div class="radio">
            <label><input <?php if($campaign->all_devices == 0) {
              echo("checked='checked'");
            }
            ?> type="radio" name="optradiodevices" value="specific">Specific Devices</label>
          </div>

          <div id="specific_devices">

            <div class="checkbox">
              <label><input <?php if($campaign->desktop_enabled == 1) {
              echo("checked='checked'");
            }
            ?>
            type="checkbox" name="desktop" id="desktop" value="desktop">Desktop</label>
            </div>
            <div class="checkbox">
              <label><input <?php if($campaign->mobile_enabled == 1) {
              echo("checked='checked'");
            }
            ?>
            type="checkbox"  name="mobile" id="mobile" value="mobile">Mobile</label>
            </div>
            <div class="checkbox">
              <label><input <?php if($campaign->tablet_enabled == 1) {
              echo("checked='checked'");
            }
            ?>
            type="checkbox" name="tablet" id="tablet" value="tablet">Tablet</label>
            </div>
          </div>

          <div id="all_or_specific_os">
            <div class="radio">
              <label><input  <?php if($campaign->all_operating_systems == 1) {
              echo("checked='checked'");
            } ?>
            type="radio" id="all_os" name="optradioos" value="all_os">All Operating Systems</label>
            </div>
            <div class="radio">
              <label><input <?php if($campaign->all_operating_systems == 0) {
              echo("checked='checked'");
            }
            ?>
            type="radio" name="optradioos" value="specific">Specific Operating Systems</label>
            </div>
          </div>
          ...
          <div id="specific_os">
            <div class="checkbox">
              <label><input <?php if($campaign->android_enabled == 1) {
              echo("checked='checked'");
            }
            ?>
            type="checkbox" name="android" value="android">Android</label>
            </div>
            <div class="checkbox">
              <label><input <?php if($campaign->ios_enabled == 1) {
              echo("checked='checked'");
            }
            ?>
            type="checkbox" name="ios" value="ios">iOS</label>
            </div>
          </div>
