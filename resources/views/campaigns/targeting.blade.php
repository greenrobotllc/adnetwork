 ...
 <div class="container">
		...
		<br>
                 ...
                 <div class="panel-heading">
					 <h2>Campaign "{{ $campaign->name }}" Block Blacklist Targeting</h2>
					...
					<button type="submit" class="btn btn-default">Save</button>
						 ...
						 <h4>Block New Publisher Sites/Apps</h4>
						 <form action="/campaign_blocks" method="post">
						 ...
						 <hr>
						 <h4>Blocked Publisher Sites/Apps</h4>
						 ...
						 {{ Form::open(['method' => 'DELETE', 'route' => ['campaign_blocks.destroy', $block->id]]) }}
